...
1. 单词写错：apple -> app
   ...
   <img src="/Users/yunwanxu/Library/Application Support/typora-user-images/image-20210804072559233.png" alt="image-20210804072559233" style="zoom:30%;" />

2. 语法错误：is -> are

### 如何把一个单词改成正确的拼写

选择和写错的单词比较类似的单词，计算**编辑距离**，即执行insert,delete,replace的minimum cost。

<img src="/Users/yunwanxu/Library/Application Support/typora-user-images/image-20210804074028594.png" alt="image-20210804074028594" style="zoom:30%;" />

### 编辑距离的计算(未完成)

编辑距离的计算也是一个动态规划算法（DP），把一个大问题表示称子问题。
...
<img src="/Users/yunwanxu/Library/Application Support/typora-user-images/image-20210804080134060.png" alt="image-20210804080134060" style="zoom: 25%;" />
